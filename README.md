...
| Category | Tools |
|----------|-------|
| **Cloud Provider** | ☁️ AWS (EC2, S3, VPC, IAM, EBS, Lambda) |
| **Containerization** | 🐳 Docker, ☸️ Kubernetes, Amazon EKS |
| **Infrastructure as Code** | ⚙️ Terraform, AWS CloudFormation |
| **CI/CD** | 🔧 Jenkins, GitLab CI/CD, AWS CodePipeline |
| **Version Control** | 📝 Git, GitHub, GitLab |
| **OS & Networking** | 🐧 Linux, 🌐 TCP/IP, DNS, VPC, Subnets |
...
| Category | Services |
|----------|----------|
| **Compute** | EC2, Lambda, EKS (Kubernetes), ECS |
| **Storage** | S3, EBS, EFS |
| **Networking** | VPC, Subnets, Security Groups, ELB, Route 53 |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/raj-birari/)
